// src/app/(app)/communication/page.tsx
...
import { testSmtpConnectionAction, getEmailSettingsAction } from '@/modules/communication/actions'; // Import actions
...
export default function TenantCommunicationPage() {
 ...
 const fetchSettings = React.useCallback(async () => {
    ...
    try {
        ...
        console.log("[Communication Page - fetchSettings] Safe settings received from action:", data);
  ...
  const handleTemplateFormSuccess = () => {
   ...
   const handleTemplateDialogClose = (open: boolean) => {
    ...
    const handleManualTestConnection = async () => {
        ...
        setConnectionStatus('checking');
        try {
             const result = await testSmtpConnectionAction(); // Call action without args
                    ...
                    <CardContent>
                         ...
                         {!isLoadingSettings && !settingsError && (
                            <EmailSettingsForm
                                ...
                                onTestConnection={handleManualTestConnection} // Pass the handler for the test button
